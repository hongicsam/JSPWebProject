	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><a onclick="checkAgreement()" href="join02.jsp"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
...
function checkAgreement() {
	var checkval = document.querySelector("input[name='agreement1']");
	if (!checkval.checked) {
